...
$(function(){
	var id=$.query.get("id");
	if(id!=null){
		var url="shoporditem/findOrdItemPart?ordid="+id;
		var clums=[
					   
					  {name:'价格',field:'price',width:50},
					  {name:'数量',field:'amount',width:50},
					  {name:'类型',field:'typename',width:100},
					  {name:'品牌',field:'bandname',width:100},
					  {name:'名称',field:'nickname',width:100},
					  {name:'配置',field:'config',width:150}
					  //{name:'合计',width:150,fun:function(row){return row.price*row.amount}}
