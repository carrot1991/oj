...
var typeid = <%=(request.getParameter("type")==null?0:Integer.parseInt(request.getParameter("type")))%>;
var bandid = <%=(request.getParameter("bandId")==null?0:Integer.parseInt(request.getParameter("bandId")))%>;
var prodId = <%=(request.getParameter("prodId")==null?0:Integer.parseInt(request.getParameter("prodId")))%>;
var role = ${sessionScope.OJ_JXC_USER.roleInfo};

var propStrs = '';
var baseUrl = "goods/listPager?role="+role+"&type="+typeid+"&bandId="+bandid+"&prodId="+prodId;
	        	  ...
	        	  if(json.success=='success'){
	        		    alert("加入购物车成功！");
	        		  	...
	        		  	if(confirm("是否采购配件？")){
	        				...
	        				//alert(path);
	        				//location.href="path%>pages/buy/listAsso.jsp?bandId="+bandid;
	        				//alert("path%>pages/buy/listAsso.jsp?bandId="+bandid);
	        				var addr = "pages/buy/listAsso.jsp?bandId="+bandid;
	        				location.href=addr;
	        			}
...
<input type=checkbox  id="tingchan" name="tingchan" value=1>显示停产型号 <br/>
                         
<br/> 配置筛选: <div id='configFilter'></div>
