...
$(function(){
	...
	//alert(role);
	$("#table").dataGrid({
		url : "user/findPager?roleId=downbiz",
		headHeight : 30,
		bodyHeight:280,
		pageHeight : 30,
		rowHeight:25,
	...
	$(".add").click(function(){
		update('创建商务账号','pages/super/user/updateBizDown.jsp?role=downbiz');
	});
});
...
<body>
<div class="h1">
   <span class="div">对下商务账号列表</span>
   <span class="add">新建 对下商务账号</span>
</div>
