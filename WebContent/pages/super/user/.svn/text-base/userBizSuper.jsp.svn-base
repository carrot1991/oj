...
$(function(){
	...
	$("#table").dataGrid({
		url : "user/findPager?roleId=superbiz",
		headHeight : 30,
		bodyHeight:280,
		pageHeight : 30,
		rowHeight:25,
	    ...
	    operates:{width:130, value:[
	                                ...
	                                update('修改超级商务账号','pages/super/user/updateBizSuper.jsp?uname='+row.uname); 
	                                	} },
	...
	$(".add").click(function(){
		update('创建超级商务账号','pages/super/user/updateBizSuper.jsp');
	});
});
...
<body>
<div class="h1">
   <span class="div">超级商务账号列表</span>
   <span class="add">新建 超级商务账号</span>
</div>
