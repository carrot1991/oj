...
$(function(){
	...
	$("#table").dataGrid({
		url : "user/findPager?roleId=upbiz",
		headHeight : 30,
		bodyHeight:280,
		pageHeight : 30,
		rowHeight:25,
	    ...
	    operates:{width:130, value:[
	                                ...
	                                {name:'分配产品', fun:function(row){
	                                update('修改对上商务账号','pages/super/user/updateBizUp.jsp?uname='+row.uname); 
	                                	} },
	...
	$(".add").click(function(){
		update('创建商务账号','pages/super/user/updateBizUp.jsp');
	});
});
...
<body>
<div class="h1">
   <span class="div">对上商务账号列表</span>
   <span class="add">新建 对上商务账号</span>
</div>
